...
1)  platform_id = "standard-v3" опечатка и нет 4 версии
2)  core_fraction = 20 минимальный параметр в яндекс облаке 20
3)  cores = 2  минимальный параметр в яндекс облаке 2

  preemptible = true  автоматически выключается через 24 часа
  core_fraction=5     гарантированный % доступности
...
![image](https://github.com/user-attachments/assets/1275f405-863e-48cb-88bb-2d89ecb3034f)
