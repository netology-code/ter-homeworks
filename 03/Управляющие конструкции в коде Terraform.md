...
1. Напишите output, который отобразит в виде списка словарей  все 5 созданных ВМ:
``` 
[
 {
  "name" = 'имя ВМ1'
...
2. Используя null_resource примените данный ansible-playbook к ВМ из инвентори-файла.
